var game = new Phaser.Game(1920,1080, Phaser.CANVAS, 'LowVolt', {preload: preload, create: create, update: update, render: render});
...
function preload() {
    game.load.image('starfield', '../assets/textures/background/space.png');
